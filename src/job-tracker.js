(function attachResumeBridgeJobTracker(root, factory) {
  ...
  function normalizeJobApplication(input = {}, options = {}) {
    ...
    return {
      ...
      catalogId: normalizeText(input.catalogId, 160),
      resumeName: normalizeText(input.resumeName, 80),
  ...
  function buildApplicationFingerprint(input = {}) {
    ...
    return [String(input.catalogId || ""), companyName, jobTitle, sourceUrl.toLowerCase(), appliedDay].join("|");
  }
