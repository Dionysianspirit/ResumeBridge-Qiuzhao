(function attachResumeBridgeMessagePolicy(root, factory) {
  ...
  const PRIVILEGED_MESSAGE_TYPES = new Set([
    "OJAF_SAVE_SETTINGS",
    "OJAF_CLEAR_SETTINGS",
    "OJAF_GET_PROFILE_LIBRARY",
    "OJAF_CREATE_PROFILE",
    "OJAF_SWITCH_PROFILE",
    "OJAF_GET_CATALOG_STATE",
    "OJAF_SAVE_CATALOG_NOTE",
    "OJAF_OPEN_CATALOG_ENTRY",
    "OJAF_GET_CATALOG_CONTEXT",
    "OJAF_EXPORT_TRACKING_BACKUP",
    "OJAF_IMPORT_TRACKING_BACKUP",
    "OJAF_LIST_MODELS",
